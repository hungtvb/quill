  ...
  <>
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 cursor-pointer">
        <p className="text-sm font-semibold text-gray-700">Quill now public</p>
      </div>
    ...
    <div>
      <div className="relative isolate">
        {/* <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 -top-50 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          <div style={{
          ...
          <li className="md:flex:1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:boder-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Either starting out with a free plan or choose our {' '} <Link href={"/pricing"} className="text-blue-700 font-semibold underline underline-offset-2">pro plan</Link>.
              </span>
            </div>
          </li>
          <li className="md:flex:1">
